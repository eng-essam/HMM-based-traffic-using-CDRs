 ...
 * 
 */
public class Map_matching_schulze_viterbi_residuals_all_with_plot_1 {
	...
	public static void main(String[] args) {
		...
		boolean plot_flag = true;

//		double[] alignment_threshold_arr = { 150 };
//		double[] sampling_time_threshold_arr = { 600 };
//		double[] radius = { 1000 };
		...
		List<String> exts = adaptor.getExts(trans_p);
