 ...
 * @author essam
 */
public class ManageGeoObsTrips {
	...
	public static void main(String[] args) {
		...
		final int etower = 490; // end tower
		 ...
		 */
		final boolean trips_flag = true; // detect trips or stops flag.

		// String dSPath = "/home/essam/traffic/SET2/";
		// String towerPath =
		// "/home/essam/traffic/Dakar/Dakar_edge-200/towers.csv";

		Hashtable<Integer, Vertex> towers = DataHandler.read_scaled_towers(towerPath, 1000);
