 ...
 * @author essam
 */
public class VerfyViterbiOldPaths {
...
//        Hashtable<Integer, String> obsTable = get_usr_trips(adaptor.readObsDUT(obsPath), 9000);
        ...
        obsTable.put(1, "211,201,188,191,224,206,204,205,210,195,181,166,137,121,93,88");
        obsTable.put(2, "241,225,226,214,197,200,175,179,165,163,140,120,124,109,104,110,113,128");
