...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	public static int DEFAULT_SIZE = 5120;
	public static int width = DEFAULT_SIZE;
	public static int height = DEFAULT_SIZE;

	// default pen radius
	private static final double DEFAULT_PEN_RADIUS = 0.0005;
	...
	private static final double BORDER = 0.005;
...
//		offscreen.rotate(90,0,0);
	...
	private static void init() {
		...
		offscreen.setBackground(new Color(0, true));
	 ...
	 *            the y-coordinate of the destination point
	 */
	public static void arrow(double x0, double y0, double x1, double y1, double r) {
