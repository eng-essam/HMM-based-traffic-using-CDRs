...
public class main_m_dbscan_2 {
    ...
    public static void main(String[] args) {
        ...
        String poi_output_file = args[3];
        String poi_sample_output_file =args[4];
//        final int min_pnts = 54;
...
//        String poi_output_file = "/home/essam/traffic/SET2/poi/poi_log_3_months.xml";
//        String poi_sample_output_file = "/home/essam/traffic/SET2/poi/poi_0_500_region_3_months.xml";
...
//        ArrayList<Region> voronoiRegions = converter.readVoronoi(vor_r_file);
        ...
        Hashtable<Integer, List<Cluster>> all_cluster = new Hashtable<>();
        Scan s = new Scan();
...
//            Scan s = new Scan();
            ...
            if (!clusters.isEmpty()) {
                all_cluster.put(usr_key, clusters);
            }
...
//            }
        ...
        s.write_xml_poi(all_cluster, poi_output_file);
//        s.write_poi(all_cluster, poi_output_file);
        Hashtable<Integer, List<Cluster>> sample = s.get_poi_region(all_cluster, 0, 300);

        s.write_xml_poi(sample, poi_sample_output_file);
